    ...
    <ScrollView className="flex-1">
      <ThemedView className="px-5 pt-8 pb-6 items-center">
        <View className="w-24 h-24 rounded-full items-center justify-center mb-4" style={{ backgroundColor: `${roleColor}20` }}>
          <MaterialIcons name="admin-panel-settings" size={44} color={roleColor} />
        </View>
        <ThemedText type="title" className="text-center">{user?.full_name || "Administrador"}</ThemedText>
        <View className="mt-2 px-4 py-1.5 rounded-full flex-row items-center" style={{ backgroundColor: `${roleColor}15` }}>
          <MaterialIcons name="admin-panel-settings" size={14} color={roleColor} />
          <ThemedText className="ml-1.5 text-sm font-semibold" style={{ color: roleColor }}>{userRole}</ThemedText>
        </View>
      </ThemedView>
