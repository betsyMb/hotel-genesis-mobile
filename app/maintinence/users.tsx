...
import { useUsers, useRoles, useCreateUser, useUpdateUser } from "@/hooks";
import { User } from "@/hooks/api/types";
import { EmptyState, StatBadge, UserCard, UserFormModal } from "@/components/shared";
import { MaterialIcons } from "@expo/vector-icons";

export default function MaintenanceUsersScreen() {
  ...
  return (
    <ThemedView className="flex-1">
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <UserCard item={item} onEdit={(u) => { setEditingUser(u); setShowForm(true); }} />
        )}
